...
export class Images extends React.Component {
    ...
    loadImages(Id) {
        ...
        $.ajax({
            url: '${envconfig.PROFILE_API_URL}/profile/profile/getEmployerProfileImage/?id=' + Id,
            headers: {
            ...
            success: function (res) {
                ...
                if (res.employerProfile.length > 0) {
                    for (var i = 0; i < res.employerProfile.length; i++) {
                        imageSrcArr.push("${envconfig.PROFILE_API_URL}/profile/profile/getEmployerProfileImages/?Id=" + res.employerProfile[i].fileName);
    ...
    fileUploadHandler(Id) {
        ...
        $.ajax({
            url: '${envconfig.PROFILE_API_URL}/profile/profile/addEmployerProfileImages',
            headers: {
                'Authorization': 'Bearer ' + cookies
            },
            type: "POST",
